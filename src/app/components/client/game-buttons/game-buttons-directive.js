...
angular
	.module('App.Client.GameButtons')
	.directive('gjClientGameButtons', function() {
		return {
			restrict: 'E',
			...
			controller: function(
				...
				if (!this.hasInstallableBuilds) {
					this.installTooltip =
						"This game doesn't have any installable builds yet.";
				} else if (!this.canInstall) {
					this.installTooltip =
						'This game is not available for installing on your OS.';
				}
				...
				this.install = function() {
					...
					this.packageDataPromise.then(function(packageData) {
