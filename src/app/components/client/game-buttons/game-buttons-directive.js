...
angular.module('App.Client.GameButtons').directive('gjClientGameButtons', function() {
	return {
		...
		scope: {
			...
			// TODO(rewrite): Get this working without needing this passed to it.
			...
			this.install = function() {
				...
				this.packageDataPromise.then(function(packageData) {
					...
					if (_.size(_.groupBy(packageData.installableBuilds, 'game_package_id')) > 1) {
						// TODO(rewrite): Get some sort of something working again so we can use this when not on game page.
