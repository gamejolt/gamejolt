angular.module( 'App.Client.StatusBar' ).directive( 'gjClientStatusBar', function()
{
	return {
		restrict: 'E',
		scope: {},
		...
		controller: function( $scope, Client_Library, Client_Launcher, Client_Installer, LocalDb_Package )
		{
			...
			$scope.$watch( 'Client_Installer.numPatching || Client_Launcher.currentlyPlaying.length', function( isShowing )
			{
