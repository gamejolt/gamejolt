		...
		this.install = function(game, localPackage) {
			...
			if (!localPackage.install_dir) {
				...
				promise = promise.then(function() {
					return localPackage.$setInstallDir(
						path.join(
			...
			function getDownloadUrl() {
				return localPackage.getDownloadUrl().then(function(response) {
			...
			return promise
				...
				.then(function() {
					var action = operation == 'install'
						? 'finished installing'
						: 'updated to the latest version';
					var title = operation == 'install'
						? 'Game Installed'
						: 'Game Updated';
