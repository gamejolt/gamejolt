import { Directive, Inject, Output, EventEmitter } from 'ng-metadata/core';
...
export class ActivityNotificationCountDirective
{
	@Output( 'gjActivityNotificationCount' ) private onNotificationsCount
	...
	fetchCount()
	{
		this.notificationModel.fetchNotificationsCount()
			.then( ( response: any ) => this.onNotificationsCount.emit( response.notificationsCount ) );
	}
}
