import { Model, defineLegacyModel } from '../../../../../_common/model/model.service';

export const CHAT_COMMAND_TYPE_COMMAND = 'command';
export const CHAT_COMMAND_TYPE_TIMER = 'timer';

export class ChatCommand extends defineLegacyModel(
	class ChatCommandDefinition extends Model {
