angular
	.module('App.Forms')
	.directive('gjFormSaveRoom', function($rootScope, $q, Form, Chat, Chat_Room) {
		var form = new Form({
			model: 'Chat_Room',
		...
		form.onInit = function(scope) {
			...
			if (scope.method == 'add') {
				...
				scope.$watchGroup(
					['formModel._type', 'formModel.is_viral_room'],
					function() {
						scope.formModel.type = scope.formModel._type;
						if (
							scope.formModel.type == Chat_Room.TYPE_CLOSED_GROUP &&
							scope.formModel.is_viral_room
						) {
