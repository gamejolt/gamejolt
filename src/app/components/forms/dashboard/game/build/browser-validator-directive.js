angular.module( 'App.Forms.Dashboard' ).directive( 'gjFormDashboardGameBuildBrowserValidator', function( $parse, Game_Build )
{
	return {
		restrict: 'A',
		require: 'ngModel',
		...
		{
			var model = $parse( attrs.gjFormDashboardGameBuildBrowserValidator )( scope );
