angular
	...
	.directive('gjFormDashboardGameMaturity', function(Form, gettextCatalog) {
		var form = new Form({
			model: 'Game',
			saveMethod: '$saveMaturity',
			template: require('./maturity.html'),
		});
		...
		form.onInit = function(scope) {
			...
			fields.forEach(function(field) {
				scope.formModel['tigrs_' + field] =
					scope.formModel['tigrs_' + field] || 0;
			});
		};
