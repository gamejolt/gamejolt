...
import { provideClientComponents as provideForGamePackageCard } from '../_common/game/package/card/card.vue';
...
export function bootstrapClient(app: App, commonStore: CommonStore) {
	...
	provideForGamePackageCard(app, {
		buttons: markRaw(AppClientPackageCardButtons),
	});
