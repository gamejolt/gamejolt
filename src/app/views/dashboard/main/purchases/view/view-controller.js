angular.module( 'App.Views' ).controller( 'Dashboard.Main.Purchases.ViewCtrl', function( $scope, App, Order, Order_Payment, Game, Game_Package, dateFilter, gettextCatalog, payload )
{
