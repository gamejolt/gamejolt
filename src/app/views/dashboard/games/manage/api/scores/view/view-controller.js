angular
	...
	.controller('Dashboard.Developer.Games.Manage.Api.Scores.ViewCtrl', function(
		$scope,
		$state,
		App,
		User_GameScore,
		...
		App.title = gettextCatalog.getString('dash.games.scores.view.page_title', {
