angular
	...
	.controller(
		'Dashboard.Developer.Games.Manage.Api.Scoreboards.Scores.User.ListCtrl',
		function(
			$scope,
			$state,
			App,
			...
			App.title = gettextCatalog.getString(
				'dash.games.scores.user.list.page_title',
				{
			...
			this.removeAll = function() {
				return ModalConfirm.show(
					...
					.then(function() {
						Growls.success(
							gettextCatalog.getString(
								'dash.games.scores.user.list.remove_growl',
								{
