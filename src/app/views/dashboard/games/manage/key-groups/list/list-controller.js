angular
	...
	.controller('Dashboard.Developer.Games.Manage.KeyGroups.ListCtrl', function(
		$scope,
		$state,
		App,
		KeyGroup,
		...
		App.title = gettextCatalog.getString('Manage Key Groups for {{ game }}', {
			game: manageCtrl.game.title,
		});

		this.onKeyGroupAdded = function(keyGroup) {
			$state.go('dash.games.manage.key-groups.edit', {
