...
import AppShopProductDiffCard from '~app/views/dashboard/shop/product/_diff/AppShopProductDiffCard.vue';
import AppShopProductDiffImg from '~app/views/dashboard/shop/product/_diff/AppShopProductDiffImg.vue';
import AppShopProductDiffMeta from '~app/views/dashboard/shop/product/_diff/AppShopProductDiffMeta.vue';
import AppShopProductDiffState from '~app/views/dashboard/shop/product/_diff/AppShopProductDiffState.vue';
import { ShopProductBaseForm } from '~app/views/dashboard/shop/product/_forms/FormShopProductBase.vue';
import { ShopDashProductStates, useShopDashStore } from '~app/views/dashboard/shop/shop.store';
