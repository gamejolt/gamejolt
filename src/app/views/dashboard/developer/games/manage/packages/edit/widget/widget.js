...
{
	$stateProvider.state( 'dashboard.developer.games.manage.packages.edit.widget', {
		url: '/widget',
		controller: 'Dashboard.Developer.Games.Manage.Packages.Edit.WidgetCtrl',
		controllerAs: 'widgetCtrl',
		templateUrl: '/app/views/dashboard/developer/games/manage/packages/edit/widget/widget.html',
		resolve: {
