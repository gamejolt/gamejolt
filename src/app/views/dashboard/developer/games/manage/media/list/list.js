angular.module( 'App.Views' ).config( function( $stateProvider, $urlRouterProvider )
{
	...
	$stateProvider.state( 'dashboard.developer.games.manage.media.list', {
		url: '',
		controller: 'Dashboard.Developer.Games.Manage.Media.ListCtrl',
		controllerAs: 'listCtrl',
		templateUrl: '/app/views/dashboard/developer/games/manage/media/list/list.html',
		resolve: {
