...
import { AppActivityFeedLazy as AppActivityFeed } from '~app/components/lazy';
...
import AppCommunityThumbnail from '~common/community/thumbnail/AppCommunityThumbnail.vue';
