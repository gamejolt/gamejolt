...
import { defineLegacyModel } from '../../model/model.service';
import { UserBaseTrophy } from './user-base-trophy.model';

export class UserGameTrophy extends defineLegacyModel(
	class UserGameTrophyDefinition extends UserBaseTrophy {
		game_id!: number;
