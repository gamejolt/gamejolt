...
<template>
	<div v-app-observe-dimensions="onDimensionsChange" class="-container">
		<svg v-if="width > 0" :viewBox="viewbox" xmlns="http://www.w3.org/2000/svg">
			...
			<rect x="0" y="0" :width="width" :height="height" mask="url(#myMask)" fill="#888" />
		</svg>
	</div>
</template>
