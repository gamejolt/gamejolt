...
// TODO: These should all just be exported constants.
export const Environment = {
	...
	clientSectionUrl: GJ_IS_DESKTOP_APP ? `${baseUrlDesktopApp}/client.html#` : '',
	...
	uploadHost: GJ_ENVIRONMENT === 'development' ? apiHost : 'https://upload.gamejolt.com',

	gameserverApiHost: GJ_ENVIRONMENT === 'development' ? apiHost : 'https://gamejolt.net',
