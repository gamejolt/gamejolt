...
// This is the output of build:server, and is the entry point for the ssr
// request. We evaluate it once at startup and reuse the exported `createApp`
// for every request. Per-request state isolation is provided by
// AsyncLocalStorage.
const serverBundleFile = path.join(serverBuildPath, 'server.cjs');
const createApp = bundleRunner.compileModule(serverBundleFile)();
