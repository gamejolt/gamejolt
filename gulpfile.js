...
var config = {
	...
	modules: {
		...
		'vendor-checkout.js': {
			bower: ['angular-credit-cards', 'angular-ui-mask'],
		},
		'jquery.js': {
			bower: ['jquery'],
		},
		'hammer.js': {
			bower: ['hammerjs', 'angular-hammer'],
		},
		'jcrop.js': {
			bower: ['jcrop'],
		},
		'graphs.js': {
			bower: ['Chart.js', 'tc-angular-chartjs'],
		},
		'upload.js': {
			bower: ['ng-file-upload'],
		},
		'ui-tree.js': {
			bower: ['angular-ui-tree'],
		},
		'chat.js': {
			components: ['chat'],
		},
		'primus.js': {
			componentVendor: ['primus'],
		},
		'error-tracking.js': {
			componentVendor: ['error-tracking'],
		},
		'theme-editor.js': {
			bower: ['spectrum'],
		},
		...
		'dash.js': {
			...
			components: ['forms/dashboard', 'site-analytics', 'site-editor-modal'],
			libComponents: [
				'model',
				'timezone',
				'colorpicker',
			...
			views: ['dashboard'],
			bower: ['moment-timezone', 'ngTimezone'],
		},
		'forums.js': {
			components: ['forms/forum', 'forum'],
			views: ['forums'],
		},
		'channels.js': {
			main: '/views/discover/channels/channels.ts',
			views: ['discover/channels'],
		},
		'radio.js': {
